...
KEYWORDS_PATTERN='similarweb|web traffic|web rank|traffic-and-engagement|traffic and engagement|channel mix|audience overlap|similar sites|ppc spend|keyword opportunity|keyword gap|\baeo\b|market sizing|market size|page mix|competitive teardown|organic search share|paid search share|brand sales|market share|app downloads|category performance|lead enrichment|share of voice|get-websites-traffic-channels|get-websites-audience-overlap-agg|get-websites-traffic-and-engagement|get-websites-similar-sites-agg|get-websites-website-rank|get-websites-ppc-spend|get-keywords-overview|get-keywords-seo-overview|get-brands-sales-performance-agg|get-categories-performance-agg|get-pages-popular-pages-agg|get-traffic-channels-share|get-lead-enrichment-website|get-lead-enrichment-company'
