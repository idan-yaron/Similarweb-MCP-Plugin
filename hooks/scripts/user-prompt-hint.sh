...
KEYWORDS_PATTERN='similarweb|web traffic|web rank|traffic-and-engagement|traffic and engagement|channel mix|audience overlap|similar sites|ppc spend|keyword opportunity|keyword gap|\baeo\b|seo audit|ai visibility|answer engine|market sizing|market size|page mix|competitive teardown|organic search share|paid search share|brand sales|market share|best sellers|top selling products|app downloads|category performance|lead enrichment|share of voice|get-website-analysis-traffic-channels|get-websites-audience-overlap-agg|get-websites-traffic-and-engagement|get-websites-similar-sites-agg|get-websites-website-rank|get-website-analysis-search-spend|get-keywords-overview|get-keywords-seo-overview|get-brands-sales-performance-agg|get-categories-performance-agg|get-pages-popular-pages-agg|get-website-analysis-traffic-channels-share|get-lead-enrichment-website|get-lead-enrichment-company|buying signal|buying signals|intent signal|intent data|tech stack|technology stack|ad network|search demand|search volume|demand trends|amazon sales|marketplace sales|asin|top brands|category leaderboard|cross retailer|retail media|get-ai-traffic-overview|get-sales-signals-intent|get-sales-signals-traffic|get-sales-signals-technology|get-demand-search-trends-aggregated|get-retail-cross-analysis-describe|get-categories-search|get-brands-search'
